...
const appendAlert = (message, type) => {
  ...
  wrapper.innerHTML = [
    ...
    '<h4 class="alert-heading" data-titulo-alert="Prueba Titulo Alerta Azulito :)">Well done!</h4>',
    '<p data-contenido-alert="Prueba Contenido Alert Bluey :3">Aww yeah, you successfully read this important alert message. This example text is going to run a bit longer so that you can see how spacing within an alert works with this kind of content.</p>',
    `   <div>${message}</div>`,
